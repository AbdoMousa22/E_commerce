...
<li><a href="{{route('web/login')}}"><i class="lni lni-home"></i> Home</a></li>
<li>Registration</li>
</ul>
</div>
</div>
...
@endif
<form class="row" method="POST" action="{{route('web/data_register')}}">
 @csrf
<div class="col-sm-12">
...
<p class="outer-link">Already have an account? <a href="{{route('web/login')}}">Login Now</a>
</p>
</form>
</div>
</div>
