...
<button id_product="{{$row->id}}" class="btn add_to_cart"><i class="lni lni-cart"></i> Add to Cart</button>
@else
...
<div class="single-banner right" style="background-image:url({{asset('web/images/banner/banner-3-bg.jpg')}});">
<div class="content">
...
<script src="{{asset('web/code.jquery.com_jquery-3.7.0.js')}}"></script>
