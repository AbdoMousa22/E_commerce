...
<div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('product/insert')}}" method="post" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="=text" class="form-control" id="exampleInputPassword4" placeholder="Sale" name="sale">
                        @error('sale') <span>{{$message}}</span> @enderror

                    </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Count</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Count" name="count">
